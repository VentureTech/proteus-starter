...
import static com.example.app.profile.ui.user.ProfileMembershipManagementLOK.*;
import static com.example.app.profile.ui.user.UserMembershipManagementLOK.BUTTON_TEXT_MODIFY;
import static com.example.app.profile.ui.user.UserMembershipManagementLOK.DELETE_CONFIRM_TEXT_FMT;
import static com.example.app.support.service.AppUtil.*;
...
@I18NFile(
    symbolPrefix = "com.example.app.profile.ui.user.ProfileRoleManagement",
    i18n = {
