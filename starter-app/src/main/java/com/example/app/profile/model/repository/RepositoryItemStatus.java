...
import static com.example.app.profile.model.repository.RepositoryItemStatusLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "com.example.app.profile.model.repository.RepositoryItemStatus",
    i18n = {
