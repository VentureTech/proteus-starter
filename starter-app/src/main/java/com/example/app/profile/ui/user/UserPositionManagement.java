...
import static com.example.app.profile.ui.user.UserPositionManagementLOK.*;
import static com.example.app.support.service.AppUtil.UTC;
 ...
 */
@I18NFile(
    symbolPrefix = "com.example.app.profile.ui.user.UserPositionManagement",
    i18n = {
