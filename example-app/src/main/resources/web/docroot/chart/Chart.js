...
(function(){
	...
	var Chart = function(context){
		...
		var width = this.width = (computeDimension(context.canvas,'Width') === "auto" ? context.canvas.width
			: computeDimension(context.canvas,'Width') || context.canvas.width);
		var height = this.height = (computeDimension(context.canvas,'Height') === "auto" ? context.canvas.height
	...
	extend(Chart.Type.prototype,{
		...
		resize : function(callback){
			...
			var canvas = this.chart.canvas,
				...
				newHeight = this.options.maintainAspectRatio ? newWidth / this.chart.aspectRatio : getMaximumHeight(this.chart.canvas) === 0 ? this.chart.canvas.height : getMaximumHeight(this.chart.canvas);
	...
	Chart.Scale = Chart.Element.extend({
		...
		calculateXLabelRotation : function(){
			...
			if (this.display){
				...
				var overrideRotation = this.ctx.canvas.getAttribute("data-xlabelrotation");
				if(overrideRotation) {
					this.xLabelRotation = overrideRotation;
