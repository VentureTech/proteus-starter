...
import static com.example.app.model.profile.MembershipTypeInfoLOK.NAME_SYSTEM_ADMIN;
 ...
 */
@I18NFile(
    symbolPrefix = "com.example.app.model.profile.MembershipTypeInfo",
    i18n = {
...
{
    /** MembershipTypeInfo. */
    SystemAdmin(NAME_SYSTEM_ADMIN(), "admin")
