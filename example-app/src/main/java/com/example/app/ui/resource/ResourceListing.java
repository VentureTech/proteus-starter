...
import static com.example.app.ui.resource.ResourceListingLOK.*;
import static java.util.Optional.ofNullable;

/**
 * Provides a UI for listing Resources using ResourceValueViewer, which is must more aesthetically pleasing than a SearchUI.
 *
 * @author Alan Holt (aholt@venturetech.net)
 * @since 4/14/16 4:36 PM
 */
@I18NFile(
    symbolPrefix = "com.lrsuccess.ldp.ui.resource.ResourceListing",
    i18n = {
...
@Configurable
public abstract class ResourceListing extends MIWTPageElementModelContainer
{
    /**
    ...
    /**
     * Get the Repositories that this ResourceListing is listing resources from
     *
     * @return repositories
     */
