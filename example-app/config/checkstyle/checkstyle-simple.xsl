...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>Venture Tech Coding Style Violations</title>
            </head>
            <body bgcolor="#FFFFEF">
                <p>
                ...
                <table border="1" cellspacing="0" cellpadding="2">
                    ...
                    <tr bgcolor="#F3F3E1">
                        <td>Warnings</td>
                        <td>
                            <xsl:number level="any" value="count(descendant::file/error[@severity='warning'])"/>
                        </td>
                    </tr>
                    <tr bgcolor="#F3F3E1">
                        <td>Errors</td>
                        <td>
                            <xsl:number level="any" value="count(descendant::file/error[@severity='error'])"/>
                        </td>
                    </tr>
                </table>
                <hr align="left" width="95%" size="1"/>
                <p>The following are violations of the Venture Tech Coding-Style Standards:</p>
                <p/>
                <xsl:apply-templates/>
            </body>
        </html>
